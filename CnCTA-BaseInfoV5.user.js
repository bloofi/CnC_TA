    ...
    const script = () => {
        ...
        const init = () => {
            const icons = {
                ...
                iconDark: 'data:image/png;base64,',
                layout24: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYAgMAAACdGdVrAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAJUExURQAAAADIABIe/7zn7ZYAAAABdFJOUwBA5thmAAAAJ0lEQVQI12NgQAGsASCIncIHWAO4ArgWICjWBQgKH+BaAILYKRQAAPUxEe8meeNQAAAAAElFTkSuQmCC',
            ...
            const Main = qx.Class.define('Main', {
                ...
                members: {
                        ...
                        switch (this.scanStatus) {
                            case 'READY':
                                ...
                                if (this.isScanAuto) {
                                    ...
                                    detail.push(`Don't forget to <u>uncheck</u> <b>Scan auto</b> when you are actively playing or it may conflict with your actions.`);
                                }
                                else {
                            ...
                            case 'FETCHING':
                                ...
                                if (this.currentScanID) {
                                    ...
                                    if (b) {
                                        const nbScanned = Object.values(this.scanObjs).filter(r => ['FETCHED', 'SENDING', 'SENT'].includes(r.status)).length;
                                        const nbTotal = Object.values(this.scanObjs).filter(r => r.status !== 'CANCELED').length;
                                        const nbCanceled = Object.values(this.scanObjs).filter(r => r.status === 'CANCELED').length;
                                        const nbSent = Object.values(this.scanObjs).filter(r => r.status === 'SENT').length;
                    ...
                    // UI Methods
                    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    displayMessage: function (message, color = logColors.NORMAL_BLACK) {
                    ...
                    displayMessageUpdate: function (message) {
                    ...
                    displayMessageScan: function (message) {
                    ...
                    displayMessageScanDetail: function (message) {
                        ...
                        if (['READY', 'END'].includes(this.scanStatus)) {
                            ...
                            this.intervals.nextScan = setInterval(() => {
                                if (['SCANNING', 'FETCHING'].includes(this.scanStatus) || goal < 0) {
                                    ...
                                    this.displayMessageScan(`Next scan : <b>${ClientLib.Vis.VisMain.FormatTimespan((goal - new Date().getTime()) / 1000)}</b>`, logColors.NORMAL_WHITE);
                                }
                            }, 1000);
                    ...
                    startScan: function () {
                                                ...
                                                switch (obj.get_VisObjectType()) {
                                                    ...
                                                    case ClientLib.Vis.VisObject.EObjectType.RegionNPCCamp:
                                                        ...
                                                        this.scanObjs[obj.get_Id()] = {
                                                            ...
                                                            x: obj.get_RawX(),
                                                            y: obj.get_RawY(),
                                                            type: obj.get_VisObjectType() === ClientLib.Vis.VisObject.EObjectType.RegionNPCBase ? 'Base' : 'Camp',
                                                            status: 'WAITING',
                                                            retry: 0,
                                                        };
                                                        break;
                        ...
                        this.lastScanId = Object.values(this.scanObjs).reduce((p, c) => Math.max(p, c.cityId), this.lastScanId);
                    ...
                    checkAndFetch: function () {
                        if (this.scanStatus === 'FETCHING') {
                            if (this.currentScanID) {
                                this.refreshScanLabel();
                                const currentScan = this.scanObjs[this.currentScanID];
                                switch (currentScan.status) {
                                    ...
                                    case 'FETCHING':
                                        ...
                                        break;
                                    case 'FETCHED':
                                        const fetchedItems = Object.values(this.scanObjs).filter(b => b.status === 'FETCHED');
                    ...
                    findNext: function () {
                        const nextBase = Object.values(this.scanObjs).find(b => b.status === 'WAITING');
                        if (nextBase) {
                    ...
                    sendScans: function (items) {
                        if (items.length) {
                            this.callApi('layout.scan', {
                    ...
                    planNextUpdate: function () {
                        ...
                        this.intervals.nextUpdate = setInterval(() => {
                            this.displayMessageUpdate(`Next update : <b>${ClientLib.Vis.VisMain.FormatTimespan((goal - new Date().getTime()) / 1000)}</b>`, logColors.NORMAL_WHITE);
                        }, 1000);
