// ==UserScript==
// @version	    2019.09.01
// @name        C&C:TA BI-CNCOpt Link Button (enemies offense)
// @namespace   http://cncopt.com/
// @icon        http://cncopt.com/favicon.ico
// @description The same as the classic Cncopt script, but this one adds an additionnal button to BI-Cncopt
// @downloadURL https://raw.githubusercontent.com/bloofi/CnC_TA/master/CnC-Opt.user.js
// @updateURL   https://raw.githubusercontent.com/bloofi/CnC_TA/master/CnC-Opt.user.js
...
2019.09.01: bloofi  Added link to BI-Cncopt
							...
							for (var i in this) {
								try {
									if (this[i] && this[i].basename == "Composite") {
                                        ...
                                        var linkBi = new qx.ui.form.Button("BI-CNCOpt", "http://cncopt.com/favicon.ico");
										linkBi.addListener("execute", function () {
											var bt = qx.core.Init.getApplication();
											bt.getBackgroundArea().closeCityInfo();
											cncopt.make_sharelink("https://spy-cnc.fr/CNC/bi/bi5/cncopt/");
										});
										this[i].add(linkBi);
